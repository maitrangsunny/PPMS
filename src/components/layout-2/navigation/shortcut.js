    ...
    return (
        <div id="shortcut">
            ...
            <span className="iconbox"> <i className="fa fa-envelope fa-4x"/> <span>Mail <span
                ...
                <li>
                    <Link to="/calendar" className="jarvismetro-tile big-cubes bg-color-orangeDark"> <span
                        className="iconbox"> <i
                ...
                <li>
                    <Link to="/misc/invoice" className="jarvismetro-tile big-cubes bg-color-blueDark"> <span
                        className="iconbox"> <i
                        className="fa fa-book fa-4x"/> <span>Invoice <span
                        className="label pull-right bg-color-darken">99</span></span> </span> </Link>
                </li>
                <li>
                    <Link to="/views/gallery" className="jarvismetro-tile big-cubes bg-color-greenLight"> <span
                        className="iconbox"> <i
                        className="fa fa-picture-o fa-4x"/> <span>Gallery </span> </span> </Link>
                </li> */}
                <li>
                    <Link to="/tai-khoan/doi-mat-khau" className="jarvismetro-tile big-cubes selected bg-color-pinkDark"> <span
                        className="iconbox"> <i className="fa fa-user fa-4x"/> <span>Thông Tin</span> </span> </Link>
                </li>
            </ul>
        </div>
    )
