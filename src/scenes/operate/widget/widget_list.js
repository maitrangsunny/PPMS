...
class WidgetList extends Component {
	...
	checkDate=()=>{
		...
		if(Date.parse(this.state.expiredDate)<Date.parse(this.state.bookedDate)){
		console.log(Date.parse(this.state.expiredDate));
		}else {
		console.log("1111");
		}
	}
		...
		<div id="content">
			...
			<div>
				...
				<form className="smart-form" id="search">
					...
					<div className="row input-order">
						<div className="col col-sm-4 col-xs-4 col-md-4 ">
						<label className="input">
						<h3>Thanh toán:</h3>
						<input
							type="text"
					...
					{/* <div className="col col-md-3 col-sm-3 col-xs-3">
						...
						id=""
						maxRestrict="#startdate"
						placeholder="Hẹn lịch"
						data-date-format="dd/mm/yy"
						value={this.state.bookedDate}
						onChange={e =>
						this.setState({ bookedDate: e.target.value })
						}
						/>
						</label>
					</div> */}
